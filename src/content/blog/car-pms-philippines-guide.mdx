...
Here's what to know — and the tell-tale sounds (`kalabog`, `kalog`, `klik-klik`):
...
- **Tie rod ends & ball joints** — the steering and suspension pivots. Senyales: maluwag o "wandering" na manibela, kalabog over bumps, and uneven tire wear.
...
- **Bushings (control arm / stabilizer)** — rubber mounts that soak up shock. Senyales: clunks at vibration na papalala.
- **Wheel bearings** — senyales: humming or "ugong" na nagbabago depende sa bilis o pag-liko.

Most of these are **talyer jobs** — a trusted suspension shop is usually far cheaper than the casa for pang-ilalim work. Magpa-check after rainy season or kapag tumama ka sa malalim na lubak. Mas mura laging palitan ang isang stabilizer link kaysa hintaying sirain nito ang gulong mo — o ang biyahe mo.
