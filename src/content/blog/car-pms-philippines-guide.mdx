...
faq:
  ...
  - q: "Ano ang dapat i-check sa pang-ilalim ng kotse?"
    a: "The key undercarriage (pang-ilalim) wear parts are your shock absorbers/struts, CV joints (axle), tie rod ends, ball joints, stabilizer links, bushings, and wheel bearings. PH roads wear these out faster than the scheduled PMS items, so have your pang-ilalim inspected during a PMS — or after rainy season or hitting a deep pothole. Watch for katok, kalabog, langitngit, kalog, klik-klik on turns, or a 'lutang' ride."
  - q: "Bakit may katok o kalabog sa pang-ilalim ng kotse?"
    a: "A katok or kalabog (knocking/clunking) over bumps usually points to worn tie rod ends, ball joints, or struts. Kalog (rattling) is often a stabilizer link, langitngit (creaking) is usually dry bushings, klik-klik on turns is a CV joint, and ugong (humming) is a wheel bearing. Magpa-inspect sa talyer para ma-pinpoint — these only get worse (at mas mahal) the longer you wait."
---
...
Here's what to know — and the tell-tale sounds (`katok`, `kalabog`, `langitngit`, `kalog`, `klik-klik`):

- **Shock absorbers / struts** — control your ride and braking. Senyales: bouncy or "lutang" na takbo, nose-dive pag preno, or oil leaking down the strut. Usually around 60,000 km+.
- **CV joint / axle (constant velocity joint)** — sends power to the front wheels. Senyales: "klik-klik" pag kumakaliwa o kumakanan, lalo na sa full lock.
- **Tie rod ends & ball joints** — the steering and suspension pivots. Senyales: maluwag o "wandering" na manibela, **katok/kalabog** over bumps, and uneven tire wear.
- **Stabilizer links (sway bar links)** — keep the car flat on turns. Senyales: that classic "kalog" / rattling over rough roads — the most common pang-ilalim noise.
- **Bushings (control arm / stabilizer)** — rubber mounts that soak up shock. Senyales: **langitngit** (creaking) at clunks na papalala.
- **Wheel bearings** — senyales: humming or "ugong" na nagbabago depende sa bilis o pag-liko.
